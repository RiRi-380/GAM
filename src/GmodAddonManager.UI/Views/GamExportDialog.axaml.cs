    ...
    public partial class GamExportDialog : Window
    {
        ...
        private async void OnBrowseClick(object? sender, RoutedEventArgs e)
        {
            try
            {
                ...
                {
                    Title = L.Get("GamExport.SaveFilePickerTitle"),
                    DefaultExtension = "gam",
                    FileTypeChoices = new[]
                    {
                        new FilePickerFileType(L.Get("GamExport.FileType"))
                        {
                            Patterns = new[] { "*.gam" }
                        }
                    },
            ...
            {
                SafeFileLogger.TryLogException("GamExportDialog.OnBrowseClick", ex);
            }
        }
        ...
        private async void OnExportClick(object? sender, RoutedEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                var messageBox = new Window
                {
                    ...
                    {
                        Text = L.Format("GamExport.SaveFailed", ex.Message),
